...
object RandomGame2048Initializer: Game2048Initializer<Int> {
    ...
    private fun generateRandomCell(board: GameBoard<Int?>, targetCellIndex: Int): Cell {
        var targetCellIndex1 = targetCellIndex
        ...
        throw IllegalStateException("Unexpected targetCellIndex $targetCellIndex")
    }
}